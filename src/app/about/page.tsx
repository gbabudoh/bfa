  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#FDFCFB] flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400 font-bold uppercase tracking-[0.3em] text-[10px]">Authenticating Heritage</p>
      </div>
    );
  }
    ...
    <main className="bg-[#FDFCFB] min-h-screen overflow-x-hidden selection:bg-yellow-200 selection:text-yellow-900">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl font-black text-gray-900 mb-8 leading-[0.9] tracking-tighter">
                {data.heroTitle.split(' ').map((word, i) => (
                  <span key={i} className={i === data.heroTitle.split(' ').length -1 ? "text-yellow-600" : ""}>
                    {word}{' '}
                  </span>
                ))}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                >
                  <span className="relative z-10">{data.heroCTA}</span>
            ...
            >
              <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border-[12px] border-white active:scale-95 transition-transform duration-500">
                <div className="aspect-[4/5] bg-yellow-50 relative">
                  <Image 
                    src={data.storyImage || "/images/hero-about.jpg"} 
                    alt="Buy from Africa" 
                    fill 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <motion.div 
              ...
              className="lg:w-1/2"
            >
              <span className="text-yellow-600 font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Our Purpose</span>
              ...
              <p className="text-xl text-gray-600 mb-10 font-bold leading-relaxed">
                  Whether you&apos;re an African business looking to expand globally or a buyer seeking authentic African products, become part of our growing community today.
                </p>
            ...
            >
              <div className="relative rounded-[4rem] overflow-hidden h-[600px] border-8 border-white shadow-2xl">
                 <Image 
                   src={data.storyImage || "/images/mission-about.jpg"} 
                   alt="Mission" 
                   fill 
                 ...
                 <div className="absolute bottom-10 left-10 text-white">
                    <p className="text-sm font-black uppercase tracking-widest opacity-80">Building Bridges</p>
                    <p className="text-2xl font-black">Trade without borders.</p>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 md:py-40 bg-gray-900 text-white rounded-[4rem] mx-4 md:mx-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              The <span className="text-yellow-500">Full Story.</span>
            </motion.h2>
          ...
          <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-white/10 pt-20">
             ...
             <div>
                ...
                <p className="text-xs font-black uppercase tracking-widest text-gray-400">Verified Vendors</p>
             </div>
             <div>
                <p className="text-4xl font-black text-yellow-500 mb-2">40%</p>
                <p className="text-xs font-black uppercase tracking-widest text-gray-400">Vendor Growth</p>
             </div>
             <div>
      ...
      <section className="py-24 md:py-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <span className="text-yellow-600 font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Behind the Vision</span>
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 leading-tight tracking-tighter">Meet The Team</h2>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-y-12 gap-x-8">
                    {data.countries.map((country, index) => (
                      ...
                      >
                         ...
                         <span className="text-lg font-black text-white/80 group-hover:text-white transition-colors tracking-tight">{country}</span>
                      </motion.div>
                    ))}
                  </div>
               </div>
      ...
      <section className="py-24 md:py-40 bg-[#FDFCFB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-gray-400 mb-20 whitespace-nowrap">Trusted Ecosystem Partners</h2>
      ...
      <section className="pb-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-5xl md:text-8xl font-black text-black mb-12 tracking-tighter leading-[0.8]">
