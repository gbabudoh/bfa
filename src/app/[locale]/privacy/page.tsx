...
export default function PrivacyPage() {
  ...
  const sections = useMemo(() => [
    ...
    { id: "dataWeCollect", icon: Search, key: "dataWeCollect" },
    { id: "howWeCollect", icon: Settings, key: "howWeCollect" },
    { id: "howWeUse", icon: UserCheck, key: "howWeUse" },
    { id: "dataSecurity", icon: Shield, key: "dataSecurity" },
    { id: "dataRetention", icon: Clock, key: "dataRetention" },
    { id: "yourRights", icon: Lock, key: "yourRights" },
    { id: "cookies", icon: ToggleRight, key: "cookies" },
