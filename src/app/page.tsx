          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className={`md:w-1/2 text-center md:text-left transition-all duration-700 ${isLoading ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                >
                  {configs.hero_btn1} <ShoppingBag className="ml-2 h-5 w-5" />
                </Link>
                <Link
                  href="/register"
                ...
                >
                  {configs.hero_btn2} <Users className="ml-2 h-5 w-5" />
                </Link>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">How Buy from Africa Works</h2>
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Connect with verified African vendors and access unique products and services with ease
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-yellow-50 rounded-xl p-8 text-center hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Register as a Buyer or Vendor</h3>
              <p className="text-gray-700">
                Create your account to get a unique ID that allows you to connect with African vendors or list your products.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 rounded-xl p-8 text-center hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Browse Products & Services</h3>
              <p className="text-gray-700">
                Explore a wide range of authentic African products and services from verified vendors across the continent.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 rounded-xl p-8 text-center hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Connect & Transact</h3>
              <p className="text-gray-700">
                Use our secure platform to contact vendors, negotiate prices, and complete transactions with trusted payment options.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Verified African Vendors</h2>
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform features two types of verified vendors to ensure trust and transparency
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-yellow-50 rounded-xl p-8 text-center md:text-left hover:shadow-lg transition flex flex-col md:flex-row items-center">
              ...
              <div>
                <div className="flex items-center justify-center md:justify-start mb-4">
                  <h3 className="text-xl font-semibold text-gray-900 mr-3">Blue Badge Vendors</h3>
                  <div className="bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-full">BLUE</div>
                </div>
                <p className="text-gray-700">
                  Individual entrepreneurs and small-scale businesses. These vendors are verified but may not have formal business registration. Perfect for discovering unique handcrafted items and personalized services.
                </p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 rounded-xl p-8 text-center md:text-left hover:shadow-lg transition flex flex-col md:flex-row items-center">
              ...
              <div>
                <div className="flex items-center justify-center md:justify-start mb-4">
                  <h3 className="text-xl font-semibold text-gray-900 mr-3">Gold Badge Vendors</h3>
                  <div className="bg-yellow-600 text-white text-xs font-bold px-2 py-1 rounded-full">GOLD</div>
                </div>
                <p className="text-gray-700">
                  Formally registered businesses with verified credentials. These vendors have provided business registration details from their respective African countries, ensuring higher levels of trust and accountability.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-b from-yellow-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to connect, communicate, and transact with African vendors
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Customizable storefronts for vendors to showcase their products and services with detailed descriptions.'
              },
              {
                icon: <MessageCircle className="h-6 w-6 text-yellow-600" />,
                title: 'Secure Messaging',
                description: 'Internal email system for secure communication between buyers and vendors.'
              },
              {
                icon: <Video className="h-6 w-6 text-yellow-600" />,
                title: 'Video Conferencing',
                description: 'Request video or voice calls to discuss products, negotiate deals, and build relationships.'
              },
              {
                icon: <CreditCard className="h-6 w-6 text-yellow-600" />,
                title: 'Secure Payments',
                description: 'Multiple approved payment options to ensure safe and convenient transactions.'
              },
              {
                icon: <Truck className="h-6 w-6 text-yellow-600" />,
                title: 'Shipping Solutions',
                description: 'Trusted shipping partners to deliver products worldwide efficiently and affordably.'
              },
              {
                icon: <Globe className="h-6 w-6 text-yellow-600" />,
                title: 'Global Access',
                description: 'Connect with African vendors from anywhere in the world and discover unique opportunities.'
              },
            ].map((feature, index) => (
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-2/3 text-center lg:text-left mb-8 lg:mb-0">
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                Ready to Buy from Africa?
              </h2>
              <p className="mt-4 text-xl text-white opacity-90 max-w-2xl">
                Join our growing community of buyers and sellers connecting African products with global markets.
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Success stories from buyers and vendors on our platform
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-2/3 mb-8 md:mb-0 md:pr-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Stay Updated with African Market Trends
                </h2>
                <p className="text-lg text-gray-700">
                  Subscribe to our newsletter to receive updates on new vendors, products, and exclusive offers from across Africa.
                </p>
              </div>
