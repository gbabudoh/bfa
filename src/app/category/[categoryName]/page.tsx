    ...
    <div className="min-h-screen bg-yellow-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
          ...
          <Link href="/browse" className="hover:text-yellow-600 transition font-medium">Categories</Link>
          {category.parent && (
            <>
              <ChevronRight className="h-4 w-4 mx-2" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-600 text-lg font-medium">
              Discover authentic {category.name.toLowerCase()} products from verified vendors across Africa.
            </p>
          </div>
