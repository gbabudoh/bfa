        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-[#1E3A8A] mb-2">
              African {vendor.businessType?.includes('Artisan') ? t('artisanDesc') : t('factoryDesc')}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-tight mb-2">{t('productionCapacity')}</h3>
                <p className="text-gray-700 font-medium">{vendor.productionCapacity}</p>
              </div>
              
              <div className="md:col-span-1 lg:col-span-2">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-tight mb-3">{t('certifications')}</h3>
