  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
        <h2 className="text-xl font-bold text-gray-900 mb-6">About {vendor.name}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Business Details */}
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-5 pb-2 border-b border-gray-100">Business Details</h3>
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <div>
                  <span className="block font-bold text-gray-900 text-sm">Address:</span>
              ...
              <li className="flex items-center group">
                ...
                <div>
                  <span className="block font-bold text-gray-900 text-sm">Business Hours:</span>
              ...
              <li className="flex items-start group">
                ...
                <div>
                  <span className="block font-bold text-gray-900 text-sm">Member Since:</span>
              ...
              {vendor.badge === 'gold' && (
                <li className="flex items-center group">
                  ...
                  <div>
                    <span className="block font-bold text-gray-900 text-sm">Registration Number:</span>
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-5 pb-2 border-b border-gray-100">Contact Information</h3>
            <ul className="space-y-4">
              <li className="flex items-center group">
                <div className="bg-[#FFFBEB] p-2 rounded-lg mr-4 group-hover:bg-[#FEF3C7] transition-colors">
                ...
                <div>
                  <span className="block font-bold text-gray-900 text-sm">Phone:</span>
              ...
              <li className="flex items-start group">
                ...
                <div>
                  <span className="block font-bold text-gray-900 text-sm">Video Call:</span>
            ...
            <div className="mt-10 p-5 bg-[#F9FAFB] rounded-xl border border-gray-100">
              <div className="flex items-center gap-3 mb-3">
                <h4 className="font-bold text-gray-900">Business Type: <span className="capitalize text-[#D9A606]">{vendor.businessType}</span></h4>
              </div>
